  ...
  >
    {[
      ...
      <rect
        ...
        width={b.w}
        height={b.h}
        fill={i % 3 === 0 ? "#152848" : i % 3 === 1 ? "#193260" : "#0f2040"}
        rx={2}
      />
    ))}
    {[
...
const S: Record<string, React.CSSProperties> = {
  ...
  left: {
    ...
    background: "linear-gradient(160deg,#0a1628 0%,#0d1f3c 55%,#091522 100%)",
    overflow: "hidden",
  },
  cityBg: {
    position: "absolute",
  ...
  logoBox: {
    ...
    alignItems: "center",
    justifyContent: "center",
    boxShadow: "0 4px 20px rgba(30,107,255,0.42)",
  },
  logoName: {
    fontSize: 22,
    fontWeight: 800,
  ...
  accent: {
    background: "linear-gradient(90deg,#1e6bff,#00c6ff)",
  ...
  submitBtn: {
    width: "100%",
    padding: "14px",
    background: "linear-gradient(90deg,#1e6bff,#1055d4)",
    border: "none",
    borderRadius: 12,
    color: "#fff",
    fontSize: 15,
    ...
    fontFamily: "'DM Sans', sans-serif",
    boxShadow: "0 4px 18px rgba(30,107,255,0.36)",
    transition: "all 0.2s",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
  ...
  successBox: {
    ...
    padding: "44px 24px",
    background: "linear-gradient(135deg,#f0fdf9,#eaf3ff)",
    borderRadius: 16,
    border: "1.5px solid #00c6a0",
  },
  toast: {
            ...
            {success ? (
              <div style={S.successBox}>
                <div
                  style={{
                    ...
                    height: 56,
                    borderRadius: "50%",
                    background: "rgba(0,198,160,0.13)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    margin: "0 auto 16px",
              ...
              <form onSubmit={handleSubmit} noValidate>
                    ...
                    <div>
                      ...
                      <div style={S.wrap}>
                        ...
                        <input
                          ...
                          placeholder="REA-XXXX-XXXX"
                          style={fStyle("licenseNumber")}
                          autoComplete="off"
                        />
                      </div>
                    ...
                    <div style={S.strengthRow}>
                      {[1, 2, 3, 4].map((i) => (
                        <div
                          ...
                          style={{
                            ...S.strengthSeg,
                            background: i <= pw.score ? pw.color : "#dce3f0",
                          }}
                        />
                      ))}
                      <span
                ...
                <p style={S.bottomTxt}>
                  ...
                  <a href="/sign-In" style={S.bottomLnk}>
                    Sign In
                  </a>
                </p>
              </form>
